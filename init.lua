...
require("lazy").setup({
	...
	-- },
	{
		...
		ft = { "typescriptreact", "typescript", "javascript", "javascriptreact", "html", "css", "scss" },
		opts = {},
		config = function()
	...
	},
	{
		...
		config = function()
			...
			lspconfig.pyright.setup({
				...
				flags = {
					debounce_text_changes = 150, -- Debounce time in milliseconds
				},
			})
...
map("n", "<leader>grn", ":TSToolsRenameFile<cr>")
map("n", "<leader>ga", ":TSToolsFixAll<cr>")
